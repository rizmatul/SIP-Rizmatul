							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$student->getGambar()}}" class="img-circle" alt="Avatar">
								...
								<div class="profile-detail">
									<div class="profile-info">
										<h4 class="heading">Detail Student</h4>
										<ul class="list-unstyled list-justify">
											<li>Email <span>{{$student->email}}</span></li>
											<li>Phone <span>{{$student->phone}}</span></li>
											<li>School <span>{{$student->school}}</span></li>
											<li>Grade <span>{{$student->grade}}</span></li>
